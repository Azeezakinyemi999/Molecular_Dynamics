#!/usr/bin/env python3
# Multi-pathway NEB: hcp_hollow__top_mo+top_cr
label = "hcp_hollow__top_mo+top_cr"
# IS: H2* at hcp_hollow  (true label: Ni_atop_physisorbed)
# FS: 2H* at top_mo + top_cr
...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_final_relaxed.lammps"
...
fs_log = "results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/fs_min.log"
E_FS = None
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_phase2.log") as _f:
...
barrier_file = "results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/7/multi/hcp_hollow__top_mo+top_cr/neb_path.dat"

with open(barrier_file, "w", encoding="utf-8") as f:
    f.write("IS : H2* at hcp_hollow\n")
    f.write("IS true label : Ni_atop_physisorbed\n")
    f.write("FS : 2H* at top_mo + top_cr\n")
