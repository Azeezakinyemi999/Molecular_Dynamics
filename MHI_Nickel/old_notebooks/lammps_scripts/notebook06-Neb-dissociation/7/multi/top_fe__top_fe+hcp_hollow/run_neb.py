#!/usr/bin/env python3
# Multi-pathway NEB: top_fe__top_fe+hcp_hollow
label = "top_fe__top_fe+hcp_hollow"
# IS: H2* at top_fe  (true label: Fe_atop_physisorbed)
...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_final_relaxed.lammps"
Z_FREEZE_CUTOFF = 22.115
E_IS            = -2397.89551643349
N_IMAGES        = 18
NEB_FMAX        = 0.05
N1_STEPS        = 5000
NEB_STEPS       = 10000
...
fs_log = "results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/fs_min.log"
E_FS = None
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_phase2.log") as _f:
...
barrier_file = "results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/7/multi/top_fe__top_fe+hcp_hollow/neb_path.dat"

with open(barrier_file, "w", encoding="utf-8") as f:
    f.write("IS : H2* at top_fe\n")
    f.write("IS true label : Fe_atop_physisorbed\n")
