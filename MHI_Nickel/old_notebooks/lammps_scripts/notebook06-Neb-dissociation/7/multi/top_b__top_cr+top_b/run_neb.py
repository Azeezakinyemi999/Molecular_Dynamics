#!/usr/bin/env python3
# Multi-pathway NEB: top_b__top_cr+top_b
label = "top_b__top_cr+top_b"
# IS: H2* at top_b  (true label: Mo_atop_physisorbed)
# FS: 2H* at top_cr + top_b
# FS true labels: CrNiNi_hollow_hcp + BCMo_bridge
...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_final_relaxed.lammps"
...
fs_log = "results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/fs_min.log"
E_FS = None
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_phase2.log") as _f:
...
barrier_file = "results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/7/multi/top_b__top_cr+top_b/neb_path.dat"

with open(barrier_file, "w", encoding="utf-8") as f:
    f.write("IS : H2* at top_b\n")
    f.write("IS true label : Mo_atop_physisorbed\n")
    f.write("FS : 2H* at top_cr + top_b\n")
    f.write("FS true label 1 : CrNiNi_hollow_hcp\n")
    f.write("FS true label 2 : BCMo_bridge\n")
