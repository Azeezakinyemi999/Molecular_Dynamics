...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/1234/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/1234/neb_final_relaxed.lammps"
Z_FREEZE_CUTOFF = 22.115  # A — bottom layers frozen
E_IS            = -2397.62206678477             # eV — from NB05 minimization
E_FS            = -2398.81056025001             # eV — from NB06 FS minimization
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/1234/neb06_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/1234/neb06_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/1234/neb06_phase2.log", "r") as _f:
...
img_dir = "structures/notebook06-Neb-dissociation/1234/neb_images"
...
traj_path = "results/notebook06-Neb-dissociation/1234/neb_path.extxyz"
...
sys.stdout.flush()
# ── Write output files ────────────────────────────────────
barrier_file = "results/notebook06-Neb-dissociation/1234/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/1234/neb_path.dat"
