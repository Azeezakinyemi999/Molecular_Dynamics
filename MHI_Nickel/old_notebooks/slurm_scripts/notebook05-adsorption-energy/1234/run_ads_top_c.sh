#!/bin/bash
#SBATCH --job-name=nb05_top_c
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=multigpu
#SBATCH --time=02:00:00
#SBATCH --output=results/notebook05-adsorption-energy/1234/slurm_top_c_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05-adsorption-energy/1234/min_top_c.lammps \
    -log results/notebook05-adsorption-energy/1234/ads_top_c.log

echo "Job top_c finished: $(date)"
