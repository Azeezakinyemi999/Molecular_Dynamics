...
#SBATCH --output=results/notebook05-adsorption-energy/1234/slurm_hcp_hollow_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05-adsorption-energy/1234/min_hcp_hollow.lammps \
    -log results/notebook05-adsorption-energy/1234/ads_hcp_hollow.log
