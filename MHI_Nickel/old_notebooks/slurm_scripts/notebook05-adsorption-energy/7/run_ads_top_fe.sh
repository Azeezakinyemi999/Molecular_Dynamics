...
#SBATCH --output=results/notebook05-adsorption-energy/7/slurm_top_fe_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05-adsorption-energy/7/min_top_fe.lammps \
    -log results/notebook05-adsorption-energy/7/ads_top_fe.log
