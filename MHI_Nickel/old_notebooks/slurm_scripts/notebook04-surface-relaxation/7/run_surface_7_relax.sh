#!/bin/bash
#SBATCH --job-name=hastelloyN_7_surf_relax
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=multigpu
#SBATCH --time=06:00:00
#SBATCH --output=results/notebook04-surface-relaxation/7/surface_relax_7_%j.log
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook04-surface-relaxation/7/surface_relax.lammps \
    -log results/notebook04-surface-relaxation/7/surface_relaxation.log
