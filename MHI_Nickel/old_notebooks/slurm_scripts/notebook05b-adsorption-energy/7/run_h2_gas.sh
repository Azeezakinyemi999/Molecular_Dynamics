#!/bin/bash
#SBATCH --job-name=nb05b_h2_gas
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=multigpu
#SBATCH --time=02:00:00
#SBATCH --output=results/notebook05b-adsorption-energy/7/slurm_h2_gas_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05b-adsorption-energy/7/min_h2_gas.lammps \
    -log results/notebook05b-adsorption-energy/7/ads_h2_gas.log

echo "h2_gas done: $(date)"
