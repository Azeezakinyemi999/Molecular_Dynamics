...
#SBATCH --output=results/notebook05-adsorption-energy/111/slurm_clean_slab_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05-adsorption-energy/111/min_clean_slab.lammps \
    -log results/notebook05-adsorption-energy/111/ads_clean_slab.log
