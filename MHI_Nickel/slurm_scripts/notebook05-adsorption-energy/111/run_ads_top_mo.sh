...
#SBATCH --output=results/notebook05-adsorption-energy/111/slurm_top_mo_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/notebook05-adsorption-energy/111/min_top_mo.lammps \
    -log results/notebook05-adsorption-energy/111/ads_top_mo.log
