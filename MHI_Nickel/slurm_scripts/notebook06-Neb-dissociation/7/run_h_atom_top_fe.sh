...
#SBATCH --output=results/notebook06-Neb-dissociation/7/slurm_h_atom_top_fe_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half -in lammps_scripts/notebook06-Neb-dissociation/7/min_h_atom_top_fe.lammps -log results/notebook06-Neb-dissociation/7/h_atom_top_fe.log
