...
#SBATCH --output=results/notebook06-Neb-dissociation/42/slurm_neb_final_%j.out
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half -in lammps_scripts/notebook06-Neb-dissociation/42/min_neb_final.lammps -log results/notebook06-Neb-dissociation/42/neb_final_min.log
