#!/bin/bash
#SBATCH --job-name=Pure_Fe_npt_300K
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition='gpu'
#SBATCH --time=04:00:00
#SBATCH --output=results/02_bulk_energy_minimization/Pure_Fe/Fe_300K_%j.log
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half \
    -in lammps_scripts/02_bulk_energy_minimization/Pure_Fe/Pure_Fe_npt_300K.lammps \
    -log results/02_bulk_energy_minimization/Pure_Fe/Fe_npt_lattice.log
