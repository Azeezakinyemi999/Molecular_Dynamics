...
STEM               = 'ni_bulk_test'
RELAXED_SLAB_PATH  = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/slab/slab_relaxed.lammps'
SURFACE_SITES_JSON = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/sites/surface_sites.json'
PHASE2_H_DIR       = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase2_h/results'
SUB_NEB_DIR        = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test'
VIB_DIR            = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/vibrations/ni_bulk_test'
RESULTS_DIR        = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/results/ni_bulk_test'

TEMPERATURES   = [600, 700]
N_H_VALUES     = [1, 3]
P_VALS_PA      = [10000.0, 100000.0, 1000000.0]
A0_M           = 3.52e-10
L_M            = 1e-06

DH_DISS_EV     = 0.3   # eV  — dissociation NEB delta_E (fill after NEB)
