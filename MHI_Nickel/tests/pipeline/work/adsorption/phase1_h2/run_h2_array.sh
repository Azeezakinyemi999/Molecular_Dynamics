#!/bin/bash
#SBATCH --job-name=h2_ads_array
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=sharing
#SBATCH --time=00:20:00
#SBATCH --output=/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase1_h2/run_h2_array_%j.out
...
SID=$(sed -n "$((SLURM_ARRAY_TASK_ID+1))p" /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase1_h2/h2_job_index.txt)
bash /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase1_h2/slurm/h2_slurm_${SID}.sh
echo "End: $(date)"
