...
STRUCTURE  = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase2_h/results/h_atom_s_0_relaxed.lammps'
MACE_MODEL = '/projects/westgroup/akinyemi.az/mace_lammps/models/mace-mh-1.model'
OUTDIR     = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/vibrations/ni_bulk_test/hopa_s_0_IS'
DELTA      = 0.01
DEVICE     = 'cpu'
