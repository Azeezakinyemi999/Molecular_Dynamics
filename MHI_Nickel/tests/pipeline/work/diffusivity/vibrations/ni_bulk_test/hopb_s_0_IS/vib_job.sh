#!/bin/bash
#SBATCH --job-name=vib_hopb_s_0_IS
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8

#SBATCH --partition=short
#SBATCH --time=01:00:00
#SBATCH --output=/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/vibrations/ni_bulk_test/hopb_s_0_IS/vib_hopb_s_0_IS_%j.out
...
python /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/vibrations/ni_bulk_test/hopb_s_0_IS/vib_run.py
echo "End: $(date)"
