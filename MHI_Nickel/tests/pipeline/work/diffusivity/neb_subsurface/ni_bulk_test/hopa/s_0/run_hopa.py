...
NEB_IS_FILE     = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/adsorption/phase2_h/results/h_atom_s_0_relaxed.lammps"
FS_RELAXED_DATA = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/sub1_fs_relaxed.lammps"
Z_FREEZE_CUTOFF = 12.92770007046936    # Å — frozen layer threshold
E_IS            = -125.489222957711               # eV — from LAMMPS IS minimisation
...
E_FS = _parse_pe_final("/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/fs_min.log")  # eV — from fs_min.log at runtime
...
NEB_STEPS       = 10000
DEVICE          = "cpu"
BARRIER_FILE    = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/neb_barrier.txt"
PATH_FILE       = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/neb_path.dat"
LOG_PHASE1      = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/hopa_phase1.log"
LOG_PHASE2      = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/hopa_phase2.log"
LABEL_IS        = "surface:s_0"
LABEL_FS        = "sub1:ss_2"
IMAGES_DIR      = "/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/images"
TRAJ_PHASE1     = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/hopa_phase1.traj'
TRAJ_PHASE2     = '/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/tests/pipeline/work/diffusivity/neb_subsurface/ni_bulk_test/hopa/s_0/hopa_phase2.traj'
