#!/bin/bash
#SBATCH --job-name=nvt_600K_Hastelloy_N_7_minimized_1H
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=multigpu
#SBATCH --time=24:00:00
#SBATCH --output=/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/slurm_scripts/600K/nvt_600K_chain_%j.out
...
RESTART_GLOB="/projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/results/600K/checkpoints/nvt_600K.*.restart"
CUTOFF_SEC=86100
FLUSH_WAIT=30
...
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half -in /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/lammps_scripts/600K/nvt_600K_restart.lammps -log /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/results/600K/nvt_600K.out
LAMMPS_BLOCK
else
    echo "No restart file found -- starting fresh."
    timeout --signal=SIGTERM --kill-after=60 "$CUTOFF_SEC" bash <<'LAMMPS_BLOCK'
/projects/westgroup/akinyemi.az/mace_lammps/lammps/build-mliap/lmp -k on g 1 -sf kk -pk kokkos newton on neigh half -in /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/lammps_scripts/600K/nvt_600K.lammps -log /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/results/Hastelloy_N_7_minimized_1H/results/600K/nvt_600K.out
LAMMPS_BLOCK
fi
