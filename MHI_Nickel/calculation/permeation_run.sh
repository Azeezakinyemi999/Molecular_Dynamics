#!/bin/bash
#SBATCH --job-name=perm_orch
#SBATCH --partition=west
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=permeation_orch_%j.out
...
python /projects/westgroup/akinyemi.az/mace_lammps/MHI_Nickel/calculation/permeation_run.py
