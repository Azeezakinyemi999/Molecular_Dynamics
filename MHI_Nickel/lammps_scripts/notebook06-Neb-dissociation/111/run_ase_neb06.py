...
E_IS            = -2393.71057718376             # eV — from NB05 minimization
E_FS            = -2394.80528020554             # eV — from NB06 FS minimization
...
with open(barrier_file, "w", encoding="utf-8") as f:
    f.write("IS : H2* at ads_bridge.log\n")
    f.write("FS : 2H* at top_fe + top_ni\n")
