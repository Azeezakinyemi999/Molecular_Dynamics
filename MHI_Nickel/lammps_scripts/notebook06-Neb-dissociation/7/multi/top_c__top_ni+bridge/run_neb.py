#!/usr/bin/env python3
# Multi-pathway NEB: top_c__top_ni+bridge
label = "top_c__top_ni+bridge"
...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_final_relaxed.lammps"
...
fs_log = "results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/fs_min.log"
E_FS = None
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_phase2.log") as _f:
...
barrier_file = "results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/7/multi/top_c__top_ni+bridge/neb_path.dat"
