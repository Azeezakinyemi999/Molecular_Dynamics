#!/usr/bin/env python3
# Multi-pathway NEB: top_cr__top_cr+bridge
label = "top_cr__top_cr+bridge"
# IS: H2* at top_cr  (true label: Cr_atop_physisorbed)
# FS: 2H* at top_cr + bridge
# FS true labels: CrNiNi_hollow_hcp + MoNiNi_hollow_hcp
...
NEB_IS_FILE     = "structures/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_initial.lammps"
FS_RELAXED_DATA = "structures/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_final_relaxed.lammps"
...
fs_log = "results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/fs_min.log"
E_FS = None
...
sys.stdout.flush()
opt1 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_phase1.log", dt=0.05)
...
sys.stdout.flush()
opt2 = MDMin(neb, logfile="results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_phase2.log", dt=0.02)
try:
...
with open("results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_phase2.log") as _f:
...
barrier_file = "results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_barrier.txt"
path_file    = "results/notebook06-Neb-dissociation/7/multi/top_cr__top_cr+bridge/neb_path.dat"

with open(barrier_file, "w", encoding="utf-8") as f:
    f.write("IS : H2* at top_cr\n")
    f.write("IS true label : Cr_atop_physisorbed\n")
    f.write("FS : 2H* at top_cr + bridge\n")
